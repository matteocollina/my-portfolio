...
import Matteo from '../../../public/images/osama.jpg';
  ...
  return (
    <>
      ...
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <Image className='w-20 h-20 rounded-full' width={50} height={50} src={"https://avatars.githubusercontent.com/u/8715726?v=4"} alt='profile picture' />
